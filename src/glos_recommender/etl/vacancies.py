...
# Download DfE apprenticeship vacancies zip.
...
# Read vacancies CSV from the zip into a DataFrame.
...
# Keep vacancies with GL* or BS* postcodes.
...
# Map a vacancy sector name to MatchKite sector tags.
...
# Infer sectors from vacancy title/skills/sector fields.
def infer_sectors(
    sector_name: Any,
    employer: str = "",
    title: str = "",
...
# Keep the most common tags from a series of lists.
...
# Map education/apprenticeship fields to entry_route tags.
...
# Infer role_family tags from sectors/title/skills.
...
# Normalise employer names for joining seed ↔ vacancies.
...
# Derive high/medium/low hiring signal from vacancy statuses.
...
# Map a size score into a band label (micro/small/…).
...
# Roll vacancies up to employer-level master rows.
...
# Build opportunity rows from vacancy clusters.
...
# Merge curated seed with vacancy-derived employers.
...
# Download vacancies zip if missing, return its path.
